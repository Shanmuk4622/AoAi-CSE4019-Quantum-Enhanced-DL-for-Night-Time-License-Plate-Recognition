...
\begin{keyword}
Automatic License Plate Recognition \sep  Hybrid Quantum-Classical Neural Network \sep  Variational Quantum Circuit \sep  Zero-DCE \sep  Bidirectional LSTM \sep  Connectionist Temporal Classification \sep  PennyLane \sep  Quantum Machine Learning \sep  NISQ \sep  Night-Time Computer Vision.
\end{keyword}
...
\caption{Complete architectural pipeline of HybridLPRNet\_8Q, illustrating the flow from night-time image input through Zero-DCE enhancement, CNN extraction, the 8-qubit VQC bottleneck, and final Bi-LSTM/CTC decoding.\label{fig:pipeline}}
\end{figure}
...
\caption{Pre-circuit and post-circuit qubit activation maps across temporal slices for a representative license plate.\label{fig:heatmaps}}
\end{figure}
...
\caption{Bloch-sphere state trajectories for the 8 qubits, showing specialized rotational behavior.\label{fig:bloch}}
\end{figure}
